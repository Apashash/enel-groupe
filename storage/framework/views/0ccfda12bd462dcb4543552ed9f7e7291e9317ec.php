                                ...
                                <div class="card text-center">
                                    <div class="card-content">
                                        <div class="card-body py-1">
                                            ...
                                            <h3 class="my-1">
                                                <?php if(\App\Models\Admin::first()->salary_date != date('Y-m-d')): ?>
                                                ...
                                                <?php endif; ?>
                                                <a href="<?php echo e(route('admin.salary.submit')); ?>" onclick="this.innerText = 'Processing...'" class="btn  btn-success">Submit Salary</a>
                                            </h3>
                                            <?php if(\App\Models\Admin::first()->salary_date == date('Y-m-d')): ?>
...
<?php echo $__env->make('admin.partials.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tnllabm1/public_html/resources/views/admin/salary.blade.php ENDPATH**/ ?>