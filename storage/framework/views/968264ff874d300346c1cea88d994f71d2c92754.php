...
<head>
    ...
    <link href="<?php echo e(asset ('v1/reg/css/chunk-vendors.1c151b78.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset ('v1/reg/css/app.ccea3db7.css')); ?>" rel="stylesheet">
    <style>
        .w750 {
            width: 375PX;
            margin: 0 auto;
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset ('v1/reg/css/331.95c82c77.css')); ?>">

    <title>Zambezi</title>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset ('v1/reg/css/517.30079196.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset ('v1/reg/css/754.a857914c.css')); ?>">
</head>
...
<body __processed_cf8ef8c9-2cce-420d-9043-f3c99d8441f6__="true"
    ...
    <div class="statusBar"><span id="time">14:21</span>
        <div class="right"><i class="cellular"></i> <i class="battery"></i></div>
    </div>
    <form action="<?php echo e(url ('register')); ?>" method="post">
    <?php echo csrf_field(); ?>
    <div id="app">
        <div data-v-0a287b54="" class="lrWarp warp">
            <div data-v-0a287b54="" class="logo"><img data-v-0a287b54="" src="<?php echo e(asset ('v1/reg/storage/files/20250123/d31927fcaaf28f702197e1850eed90e6.png')); ?>" alt="logo">
            </div>
            <div data-v-0a287b54="" class="contWarp">
                <div data-v-0a287b54="" class="tab">
                    <ul data-v-0a287b54="">
                        <li data-v-0a287b54="" class=""><span data-v-0a287b54="">Login</span></li>
                        <li data-v-0a287b54="" class="active"><span data-v-0a287b54="">Register</span></li>
                    </ul>
                </div>
                <div data-v-0a287b54="" class="cont">
                    <ul data-v-0a287b54="">
                        <li data-v-0a287b54="">
                            <div data-v-0a287b54="" class="van-cell van-field">
                        ...
                        <li data-v-0a287b54="">
                            <div data-v-0a287b54="" class="van-cell van-field">
                                ...
                                <div class="van-cell__value van-cell__value--alone van-field__value">
                                    <div class="van-field__body"><input type="password" placeholder="Password" class="van-field__control">
                                        <div class="van-field__right-icon"><i data-v-0a287b54="" class="eye noeye"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li data-v-0a287b54="">
                            <div data-v-0a287b54="" class="van-cell van-field">
                                ...
                                <div class="van-cell__value van-cell__value--alone van-field__value">
                                    <div class="van-field__body"><input type="password" name="password" placeholder="Confirm Password" class="van-field__control">
                                        <div class="van-field__right-icon"><i data-v-0a287b54="" class="eye noeye"></i>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <li data-v-0a287b54="">
                            <div data-v-0a287b54="" class="van-cell van-field">
                                <div class="van-field__left-icon"><i class="van-icon van-icon-inCode"><!----></i></div>
                                <div class="van-cell__value van-cell__value--alone van-field__value">
                                    <div class="van-field__body"><input type="text" name="ref_by"
                                           value="<?php echo e(isset($ref_by) && !empty($ref_by) && $ref_by != null ? $ref_by :""); ?>"   placeholder="Invitation Code" class="van-field__control">
                                    </div>
                                </div>
                            </div>
                        </li>
                        <!---->
                        <li data-v-0a287b54="">
                            <div data-v-0a287b54="" role="checkbox" tabindex="0" aria-checked="true"
                                class="van-checkbox">
                        ...
                        <li data-v-0a287b54="">
                            <button data-v-0a287b54="" onclick="login()" class="van-button van-button--info van-button--normal van-button--block van-button--round"><div data-v-0a287b54="" class="van-button__content"><span data-v-0a287b54="" class="van-button__text"> Register </span></div></button>
                        </li>
                        <li data-v-0a287b54="">
                            <button data-v-0a287b54="" onclick="window.location.href='<?php echo e(route ('login')); ?>'" type="button" class="van-button van-button--default van-button--normal van-button--plain van-button--block van-button--round"><div data-v-0a287b54="" class="van-button__content"><span data-v-0a287b54="" class="van-button__text"> Have an account? Go login now </span></div></button>
                        </li>
                        <li data-v-0a287b54="">
                            <p data-v-0a287b54=""><a data-v-0a287b54="" target="downloadFile"
                                    href="https://t.me/TNL_LAB_WEBSITE_DEVELOPER">
                                    Download App &gt;&gt;</a></p>
                        </li>
                        <li data-v-0a287b54="">
                            <p data-v-0a287b54=""> Change the current language <span data-v-0a287b54="">English</span>
                            </p>
                        </li>
                    </ul>
                </div>
...
</html><?php /**PATH /home/tnllabm1/public_html/resources/views/app/auth/registration.blade.php ENDPATH**/ ?>